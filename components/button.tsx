...
export const buttonVariants = cva(
  "rounded-sm h-10 text-base font-bold inline-flex gap-x-2 items-center justify-center transition-colors duration-200 disabled:cursor-not-allowed disabled:bg-button-disabled disabled:border-button-disabled",
  {
    variants: {
      variant: {
        default:
